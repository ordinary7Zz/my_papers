...
Additionally, PPO-based CCA optimization improves segmentation quality before downstream reasoning, while the full ThyroidAgent system further boosts segmentation and classification performance through evidence-aware expert selection and aggregation. The expanded analysis focuses on Dice and HD95 for segmentation, together with AUROC, AUPRC, sensitivity, specificity, and accuracy for classification, under heuristic routing, radiomics-free variants, and reduced-expert settings.
